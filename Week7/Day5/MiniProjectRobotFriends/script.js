...
function displayRobotos(robots) {
  for (const robot of robots) {
    ...
    divImage.style.backgroundImage = `url("${robot.image}")`;
...
function updateRobotlist(e) {
  ...
  eraseContainer();
  displayRobotos(newList);
}

function eraseContainer() {
  area.innerHTML = "";
}
displayRobotos(robots);
input.addEventListener("keyup", updateRobotlist);
